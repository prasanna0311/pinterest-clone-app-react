...
function Login({ toggleModal }) {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://pinterestappnode.herokuapp.com/users/login", myData)
      .then((response) => {
        // return  response;
  ...
  const onLoginSuccess = async (res) => {
    ...
    axios
      .post("https://pinterestappnode.herokuapp.com/users/GoogleLogin", data)
      .then((response) => {
        // return  response;
      ...
      .catch((error) => {
        //return  error;
        console.log("failed to login prasanna")
      });
  };
